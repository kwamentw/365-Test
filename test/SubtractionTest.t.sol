...
contract SubtractionTest is Test{
    ...
    function testSubtraction() public {
        ...
        assertEq(sub.result(), 2345661-3454422);
    }
    ...
    function testRevert_resultUnderflow() public {
        // testing results for undeflow
        vm.expectRevert();
        //calculating for undeflow in inputs
        sub.subDigits(-57896044618658097711785492504343953926634992332820282019728792003956564819968,2334);
        
    }

    function testOverflowErr() public {
